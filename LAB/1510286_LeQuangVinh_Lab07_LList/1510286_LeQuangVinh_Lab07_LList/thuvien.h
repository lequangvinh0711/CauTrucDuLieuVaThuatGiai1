int Search(LLIST l, datac x);
int Search_Pos_First(LLIST l, datac x);
int Search_Pos_End(LLIST l, datac x);
void Search_All_Pos_x(LLIST l, datac x);
NODE* Search_End(LLIST l, datac x);
int Head_New(LLIST& l, datac x);
